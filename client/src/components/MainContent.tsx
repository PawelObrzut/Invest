export default function MainContent() {
  return (
    <main className="ml-64 transition-all duration-300 h-screen flex flex-col overflow-hidden bg-blue-800">
      <header className="bg-blue-800 border-b border-blue-400 px-8 py-6 flex-shrink-0">
        <h1 className="text-3xl font-bold text-grey-100">Dashboard</h1>
        <p className="text-grey-500 text-sm mt-1">Real-time market data and portfolio analytics</p>
      </header>
